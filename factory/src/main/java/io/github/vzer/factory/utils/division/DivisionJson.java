...
/**
 * @authorYangCihang
 * @since17/8/14. emailyangcihang@hrsoft.net
 */

public class DivisionJson {
    public static final String DIVISION_JSON = "data:[{name:北京,city:[{name:北京,area:[东城区,西城区,崇文区,宣武区,朝阳区,丰台区,石景山区,海淀区,门头沟区,房山区,通州区,顺义区,昌平区,大兴区,平谷区,怀柔区,密云县,延庆县]}]}," +

            "{name:天津,city:[{name:天津,area:[和平区,河东区,河西区,南开区,河北区,红桥区,塘沽区,汉沽区,大港区,东丽区,西青区,津南区,北辰区,武清区,宝坻区,宁河县,静海县,蓟县]}]}," +

            "{name:河北,city:[" +

            "{name:石家庄,area:[长安区,桥东区,桥西区,新华区,郊区,井陉矿区,井陉县,正定县,栾城县,行唐县,灵寿县,高邑县,深泽县,赞皇县,无极县,平山县,元氏县,赵县,辛集市,藁,晋州市,新乐市,鹿泉市]}," +

            "{name:唐山,area:[路南区,路北区,古冶区,开平区,新区,丰润县,滦县,滦南县,乐亭县,迁西县,玉田县,唐海县,遵化市,丰南市,迁安市]}," +

            "{name:秦皇岛,area:[海港区,山海关区,北戴河区,青龙满族自治县,昌黎县,抚宁县,卢龙县]}," +

            "{name:邯郸,area:[邯山区,丛台区,复兴区,峰峰矿区,邯郸县,临漳县,成安县,大名县,涉县,磁县,肥乡县,永年县,邱县,鸡泽县,广平县,馆陶县,魏县,曲周县,武安市]}," +

            "{name:邢台,area:[桥东区,桥西区,邢台县,临城县,内丘县,柏乡县,隆尧县,任县,南和县,宁晋县,巨鹿县,新河县,广宗县,平乡县,威县,清河县,临西县,南宫市,沙河市]}," +

            "{name:保定,area:[新市区,北市区,南市区,满城县,清苑县,涞水县,阜平县,徐水县,定兴县,唐县,高阳县,容城县,涞源县,望都县,安新县,易县,曲阳县,蠡县,顺平县,博野,雄县,涿州市,定州市,安国市,高碑店市]}," +

            "{name:张家口,area:[桥东区,桥西区,宣化区,下花园区,宣化县,张北县,康保县,沽源县,尚义县,蔚县,阳原县,怀安县,万全县,怀来县,涿鹿县,赤城县,崇礼县]}," +

            "{name:承德,area:[双桥区,双滦区,鹰手营子矿区,承德县,兴隆县,平泉县,滦平县,隆化县,丰宁满族自治县,宽城满族自治县,围场满族蒙古族自治县]}," +

            "{name:沧州,area:[新华区,运河区,沧县,青县,东光县,海兴县,盐山县,肃宁县,南皮县,吴桥县,献县,孟村回族自治县,泊头市,任丘市,黄骅市,河间市]}," +

            "{name:廊坊,area:[安次区,固安县,永清县,香河县,大城县,文安县,大厂回族自治县,霸州市,三河市]}," +

            "{name:衡水,area:[桃城区,枣强县,武邑县,武强县,饶阳县,安平县,故城县,景县,阜城县,冀州市,深州市]}" +
            ...
            "{name:长治,area:[城区,郊区,长治县,襄垣县,屯留县,平顺县,黎城县,壶关县,长子县,武乡县,沁县,沁源县,潞城市]}," +

            "{name:晋城,area:[城区,沁水县,阳城县,陵川县,泽州县,高平市]}," +

            "{name:朔州,area:[朔城区,平鲁区,山阴县,应县,右玉县,怀仁县]}," +

            "{name:忻州,area:[忻府区,原平市,定襄县,五台县,代县,繁峙县,宁武县,静乐县,神池县,五寨县,岢岚县,河曲县,保德县,偏关县]}," +

            "{name:吕梁,area:[离石区,孝义市,汾阳市,文水县,交城县,兴县,临县,柳林县,石楼县,岚县,方山县,中阳县,交口县]}," +

            "{name:晋中,area:[榆次市,介休市,榆社县,左权县,和顺县,昔阳县,寿阳县,太谷县,祁县,平遥县,灵石县]}," +

            "{name:临汾,area:[临汾市,侯马市,霍州市,曲沃县,翼城县,襄汾县,洪洞县,古县,安泽县,浮山县,吉县,乡宁县,蒲县,大宁县,永和县,隰县,汾西县]}," +
            ...
            "{name:呼和浩特,area:[新城区,回民区,玉泉区,郊区,土默特左旗,托克托县,和林格尔县,清水河县,武川县]}," +
